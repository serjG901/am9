...
function generateSVGUrl(colorHex: string, text: string) {
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="96" height="96">
        ...
        <text x="50%" y="50%" font-size="64" font-family="Outfit, Inter, system-ui, Avenir, Helvetica, Arial, sans-serif" text-anchor="middle" dominant-baseline="middle" fill="black">${text}</text>
    </svg>`;
